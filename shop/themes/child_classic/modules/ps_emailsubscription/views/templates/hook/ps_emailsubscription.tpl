<div class="container mt-7 pb-5 pb-md-4">
  <div class="hide-show-text">
    <h2>Kamienie szlachetne i półszlachetne - dlaczego nasz sklep?</h2>
    <p>Decydując się na zakup w naszym sklepie kamieni szlachetnych i półszlachetnych, można mieć pewność otrzymania
      oryginalnych, naturalnych okazów oraz produktów z nich wykonanych. <strong>Uczciwość wobec naszych Klientów ma dla
        nas najwyższy priorytet. </strong>Dokładamy wszelkich starań, aby oferowane <a
        href="/12-mineraly"><u>minerały</u></a>, <a href="/91-skamieliny"><u>skamieniałości</u></a> czy wykonana z nich
      biżuteria, były najwyższej jakości. Przy każdym produkcie zamieszczony jest opis, który ułatwia dokonanie
      właściwego wyboru.</p>
    <div class="collapse" id="collapseMainText">
      <p><strong>W naszym sklepie stawiamy na profesjonalną obsługę zamówień</strong>. Zakupione kamienie starannie
        pakujemy, aby dotarły do swojego właściciela w nienaruszonym stanie. Dostępność na magazynie wszystkich
        znajdujących się w ofercie kamieni pozwala nam na ekspresową realizację zamówienia. Rzetelność naszego sklepu z
        minerałami i kamieniami szlachetnymi potwierdzają pozytywne opinie, które otrzymujemy od zadowolonych Klientów.
      </p>
      <h2>Minerały - co mamy w asortymencie naszego sklepu?</h2>
      <p>Minerały urzekają swoim pięknem i inspirują. Od wieków podziwiane są za elegancką geometrię, idealną symetrię i
        bogatą kolorystykę. Posiadają charakterystyczne właściwości chemiczne i fizyczne oraz zwykle regularną strukturę
        krystaliczną. Na świecie znanych jest ponad 4000 minerałów, które różnią się właściwościami, miejscem
        występowania czy zastosowaniem. W naszej ofercie znajdziesz minerały z całego świata, uformowane w wyniku
        naturalnych procesów geologicznych. Powstają zazwyczaj, gdy stopiona skała lub magma ochładza się i oddziela od
      ...
      <p>Skamieniałości to pozostałości lub ślady dawnego życia roślin i zwierząt, które zostały zachowane w wyniku
        naturalnych procesów. Te prehistoryczne dowody organizmów żyjących miliony lat temu obejmują zarówno
        spektakularne szkielety, maleńkie muszle morskie, jak również odciski i pleśnie organizmów, a także ślady ich
        życia, utworzone w osadach. <strong>Proces powstawania skamielin nazywany jest fosylizacją</strong>. Aby
        wystąpił, konieczne są specjalne warunki, takie jak szybkie zakopanie przez osady w wodzie, podczas lawiny
      ...
      <h2>Kamienie i minerały dla dzieci - strefa młodego kolekcjonera</h2>
      <p>Szukasz prezentu dla swojego dziecka? Chciałbyś zainteresować go kamieniami naturalnymi i zaszczepić w nim
        kolekcjonerskiego bakcyla? Jeśli tak to koniecznie przejrzyj tę kategorię w naszym sklepie internetowym. Strefa
        Młodego Kolekcjonera to zbiór ciekawych i niedrogich minerałów oraz skamieniałości. Wybrane przez nas kamienie
        niejednokrotnie oferowane są w pudełkach wraz z metryczką, gdzie podana jest nazwa oraz miejsce jego
        pochodzenia. To znakomite, kolorowe okazy na początek kolekcjonerskiej przygody.</p>
      ...
      <p>Wybierając wyjątkowe wyroby z kamieni naturalnych, czy to w postaci wazonów, obelisków, <a
        ...
        są ręcznie z materiałów wysokiej jakości, o ciekawej barwie i strukturze. Będą zarówno wspaniałym uzupełnieniem
        kolekcji, jak też znakomicie urozmaicą Twoje mieszkanie.
      </p>
      <h2>Znajdź kamień dla znaku Zodiaku</h2>
...
<div class="">
  <div class="">
    ...
    <div class="block_newsletter col-12 py-3 py-lg-4 bg-gold-dark lazyload entered loaded"
      ...
      style="background-image: url(&quot;https://sklep.magiakamieni.pl/img/kamienie_newsletter.webp&quot;);">
      <div class="container">
